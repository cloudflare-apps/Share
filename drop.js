  ...
  var DropInstance = (function (_Evented) {
    ...
    _createClass(DropInstance, [{
      ...
      value: function close() {
        ...
        console.log('this.drop.addEventListener(transitionEndEvent, this.transitionEndHandler);', this.drop);
        console.log(getComputedStyle(this.drop).transitionDuration);
